          ...
          <div className="flex flex-col w-1/2" >
                  ...
                  <table className="min-w-full table-auto border-spacing-2">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="px-6 py-2 text-left bg-gray-200">Familia</th>
                        <th className="px-6 py-2 text-left bg-gray-200">codControl</th>
                        <th className="px-6 py-2 text-left bg-gray-200">controlName</th>
                        <th className="px-6 py-2 text-left bg-gray-200">fecRegister</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="px-6 py-2 bg-gray-100">Registros inusuales</td>
                        <td className="px-6 py-2 bg-gray-100">AUT001</td>
                        <td className="px-6 py-2 bg-gray-100">Concentrador de IPs</td>
            ...
            <div className="mt-5 h-full  p-8 bg-white rounded-lg shadow dark:border  dark:bg-gray-800 dark:border-gray-700  ">
              ...
              <div className="flex flex-wrap -mx-3 mb-6  ">
                <div
                  {...getRootProps()}
                  className={`p-6 border-2 text-center cursor-pointer w-full border-dashed rounded-md transition-colors ${isDragActive ? 'border-blue-600 bg-blue-50' : 'border-gray-300 bg-gray-50 '
                    }`}
                >
                  <input {...getInputProps()} />
                  {isDragActive ? (
                    ...
                    <p className="text-gray-600">Arrastra y suelta archivos aquí, o haz clic para seleccionar archivos</p>
                  )}
                </div>
                <div className="w-full  mt-5 bg-white rounded-lg shadow-lg mb-5 ">
                  <table className="min-w-full table-auto border-spacing-4">
                    <thead>
                      <tr className="bg-gray-100">
                        <th className="px-6 py-2 text-left bg-gray-200">Document Name</th>
                        <th className="px-6 py-2 text-left bg-gray-200">Analyst Name</th>
                        <th className="px-6 py-2 text-left bg-gray-200">Fec Registro</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="px-6 py-2 bg-gray-100">DocumentoExcel_123456789.xlsx</td>
                        <td className="px-6 py-2 bg-gray-100">Nelson Choque</td>
                        <td className="px-6 py-2 bg-gray-100">2024-08-12 22:24:32.423</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2 bg-gray-100">DocumentoPPT_123456789.xlsx</td>
                        <td className="px-6 py-2 bg-gray-100">Nelson Choque</td>
                        <td className="px-6 py-2 bg-gray-100">2024-08-12 23:24:32.423</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2 bg-gray-100">DocumentoWord_123456789.xlsx</td>
                        <td className="px-6 py-2 bg-gray-100">Nelson Choque</td>
                        <td className="px-6 py-2 bg-gray-100">2024-08-12 20:24:32.423</td>
                      </tr>
                      <tr>
                        <td className="px-6 py-2 bg-gray-100">DocumentoTXT_123456789.xlsx</td>
                        <td className="px-6 py-2 bg-gray-100">Nelson Choque</td>
                        <td className="px-6 py-2 bg-gray-100">2024-08-12 21:24:32.423</td>
                      </tr>
                    </tbody>
                  </table>
